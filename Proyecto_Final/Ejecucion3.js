...
function JUEGOlvl3() {
    ...
    function Aumentar_Puntoslvl3() {
        Puntajelvl3++;
        document.getElementById("Puntajelvl3").innerHTML = Puntajelvl3 + " / 37"
        if (Puntajelvl3 == 1) {
            Puntajelvl3 = 0
            Tiempolvl3 = 51
            ...
            function Creditoslvl3() {
                ...
                document.getElementById("Creditoslvl3").style.top = "-20%"
                document.getElementById("Creditoslvl3").style.transition = "10s"
                document.getElementById("Proximolvl3").style.bottom = "-25%"
                document.getElementById("Proximolvl3").style.transition = "21s"
            }
    ...
    function Meteorito_Direccionlvl3() {
        Distancia1lvl3 = 80
        Altura1lvl3 = Math.round(Math.random() * 470)
    ...
    Intervalo_Dirlvl3 = setInterval(Meteorito_Direccionlvl3, 2750)

    //ESTA FUNCION DIRIGE AL METEORITO 2 A LA TIERRA         
    function Meteorito_Direccion2lvl3() {
        Distancia2lvl3 = 80
        Altura2lvl3 = Math.round(Math.random() * 470)
    ...
    Intervalo_Dir2lvl3 = setInterval(Meteorito_Direccion2lvl3, 2050)

    //ESTA FUNCION DIRIGE AL METEORITO 3 A LA TIERRA
    function Meteorito_Direccion3lvl3() {
        Distancia3lvl3 = 80
        Altura3lvl3 = Math.round(Math.random() * 470)
    ...
    setTimeout(Meteorito_Direccion3lvl3, 2500)
