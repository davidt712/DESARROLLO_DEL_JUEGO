...
//FUNCION DE NARRACIONES2

Narracion_2 = 1
document.getElementById("Contenedor_Voz_Ganastes").addEventListener('click', Narracion_Ganaste)

function Narracion_Ganaste(){
if(Narracion_2 == 1){
document.getElementById("Ganaste").play()
document.getElementById("Sin_Audio").style.display = "none"
document.getElementById("Ganaste_audio").style.display = "block"
Narracion_2 = 2}

else{
document.getElementById("Ganaste").pause()
document.getElementById("Ganaste_audio").style.display = "block"
document.getElementById("Sin_Audio").style.display = "none"
Narracion_2 = 1}}
...
function JUEGO(){
    ...
    function Tiempo_Disminur(){ //FUNCION QUE REDUCE EL TIEMPO Y RESETEAL EL RESULTADO UNA VEZ LLEGUE A 0
        ...
        function Aumentar_Puntos(){
            ...
            if(Puntaje == 27){
                ...
                Swal.fire({
                    ...
                    html: '<b class="Aumentar puntos">Sabia que lo lograrias, nos savlaste de la destruccion, ahora que esperas para descubrir la sorpresa</b>',
                    icon: 'sucess',
                    width: '50%',
                    height: '80%',
                    timer: 5000,
                ...
                clearInterval(Restar_Tiempo)
                    ...
                    document.getElementById("Volver_a_intentar").addEventListener('click', Intentarlo_de_nuevo)
                    
                    function Intentarlo_de_nuevo(){
                        ...
                        setTimeout(Metiorito_Direccion, 100)
                        ...
                        setTimeout(Metiorito_Direccion2, 100)//PRIMERO VA A SER EJECUTADO A LOS DOS PRIMEROS SEGUNDOS
        ...
        function Explulsar (){
            ...
            Distancia = "-500"
            Altura = Math.round(Math.random()* 600)
